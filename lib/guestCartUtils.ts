...
export const getCheckoutOptions = async (): Promise<{
  ...
  try {
    ...
    const response = await fetch('https://backend.madeinarnhemland.com.au/api/cart/checkout-options', {
      method: 'GET',
      headers: {
...
export const guestCartUtils = {
  ...
  calculateGuestCartTotalsFromAPI: async (
    ...
    try {
      const response = await fetch("https://backend.madeinarnhemland.com.au/api/cart/calculate-guest", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const syncGuestCartAfterLogin = async (token: string): Promise<void> => {
  ...
  try {
    await fetch('https://backend.madeinarnhemland.com.au/api/cart/sync', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
