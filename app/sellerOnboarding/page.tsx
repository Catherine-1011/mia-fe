    ...
    <div className="relative min-h-screen bg-[#EAD7B7] py-8 sm:py-12 px-4">
      ...
      <div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {/* Form Card */}
          <div className="bg-white rounded-2xl shadow-2xl p-10 border border-[#5A1E12]/15">
            {/* ── Accuracy Notice — conditional on step ── */}
            {currentStep === 6 ? (
              <div className="flex items-start gap-3 bg-amber-50 border border-amber-300 rounded-xl px-4 py-3 mb-6">
                ...
                <p className="md:text-sm text-xs text-amber-800 leading-relaxed">
                  ...
                  please note that the Stripe KYC process may take around 5–10
                  minutes to complete and will create your seller Stripe
                  account. Please remember the email ID and password used during
                  the setup.
                  <br />
                ...
                <div>
                  ...
                  <div ref={phoneDropdownRef} className="relative">
                    ...
                    >
                      ...
                      >
                        <img
                          src={`https://flagcdn.com/20x15/${phoneCountry.code.toLowerCase()}.png`}
            ...
            {currentStep === 6 && (
              <div className="space-y-6">
                <h3 className="text-xl font-semibold text-[#5A1E12] mb-2">
                  Set Up Your Payout Account
                </h3>
                <p className="text-sm text-[#5A1E12]/70 leading-relaxed">
                  To receive payments from your sales, you need to connect a
                  Stripe account. Stripe handles your identity verification and
                  bank details securely. Click below to complete the setup.
                </p>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-green-50 border border-green-300 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-green-700 mt-0.5">
                          Your payout account is active and ready to receive
                          payments.
                        </p>
                      </div>
                    </div>
